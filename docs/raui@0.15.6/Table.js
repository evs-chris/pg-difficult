(function (global, factory) {
  ...
  (factory((global.RauiTable = {}),global.Ractive));
  ...
  Ractive$1.extendWith(Table, {
    ...
    events: {},
    use: [makeClick({ name: 'clickd', count: 1 }), makeClick({ name: 'dblclickd', count: 2 }), plugin$2(), plugin$3()],
    on: {
      construct: construct,
        ...
        handler: function handler(v) {
          ...
          if (v === 'auto' || v === 'virtual' || v instanceof Ractive$1) {
            ...
            var fn = function () {
              ...
              if (fn.last === size && sized$$1) { return; }
            ...
            var fnd = function () {
              ...
              tm = setTimeout(function () {
                fn();
                tm = null;
                if (sized$$1 && this$1._scrollListener) { this$1._scrollListener.fn(); }
              }, 50);
            };
