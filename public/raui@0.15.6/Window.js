(function (global, factory) {
  ...
  (factory((global.RauiWindow = {}),global.Ractive));
}(this, (function (exports,Ractive$1) { 'use strict';

  var Ractive$1__default = 'default' in Ractive$1 ? Ractive$1['default'] : Ractive$1;
  ...
  var escape = Ractive$1__default.escapeKey;
  var windowTrans;
  ...
  Ractive$1__default.extendWith(Base, {
  ...
  var Host = /*@__PURE__*/(function (Base) {
    ...
    Host.prototype.placeAll = function placeAll () {
      ...
      var winids = Object.keys(this.get('windows') || {}).filter(function (k) { return this$1.get(("windows." + (Ractive$1__default.escapeKey(k)) + ".show")); });
  ...
  Ractive$1__default.transitions.modal = function(t, parms) {
  ...
  var Window = /*@__PURE__*/(function (Base) {
